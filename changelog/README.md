...
Per-change notes for the GroupDocs.Annotation.Mcp integration tests repo, captured
...
id: 001
date: 2026-04-23
package-under-test: 26.5.0   # version of GroupDocs.Annotation.Mcp the suite targets
...
`package-under-test` field records which `GroupDocs.Annotation.Mcp` version the
