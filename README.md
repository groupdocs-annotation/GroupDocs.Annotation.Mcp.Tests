...
Integration tests for the [`GroupDocs.Annotation.Mcp`](https://www.nuget.org/packages/GroupDocs.Annotation.Mcp)
NuGet package — an MCP server that exposes
[GroupDocs.Annotation](https://products.groupdocs.com/signature) as AI-callable tools.
...
- **Synthetic** — a blank PDF and a 1×1 JPEG built from byte-arrays in
  [SampleDocuments.cs](src/GroupDocs.Annotation.Mcp.Tests/Fixtures/SampleDocuments.cs)
