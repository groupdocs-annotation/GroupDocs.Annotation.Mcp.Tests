...
This repo's test suite validates the **published** `GroupDocs.Annotation.Mcp`
...
Synthetic PDF/JPEG fixtures ([SampleDocuments.cs](../src/GroupDocs.Annotation.Mcp.Tests/Fixtures/SampleDocuments.cs))
...
- name: Dispatch integration tests
  ...
  run: |
    gh api \
      repos/groupdocs-annotation/GroupDocs.Annotation.Mcp.Tests/dispatches \
...
base64 -w0 GroupDocs.Total.lic | gh secret set GROUPDOCS_LICENSE \
  --repo groupdocs-annotation/GroupDocs.Annotation.Mcp.Tests
```
