...
```bash
docker pull ghcr.io/groupdocs-annotation/annotation-net-mcp:26.5.0   # pinned to exact version
...
(
  ...
  sleep 2
    ...
    -v $(pwd)/documents:/data \
    ghcr.io/groupdocs-annotation/annotation-net-mcp:26.5.0 2>/dev/null
```
...
services:
  groupdocs-annotation-mcp:
    image: ghcr.io/groupdocs-annotation/annotation-net-mcp:26.5.0
    stdin_open: true
    tty: false
    environment:
...
docker inspect ghcr.io/groupdocs-annotation/annotation-net-mcp:26.5.0 \
