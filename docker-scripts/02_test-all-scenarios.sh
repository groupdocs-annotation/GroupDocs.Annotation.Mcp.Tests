#!/bin/bash
################################################################################
# GroupDocs.Annotation.Mcp — Integration Test Runner (local)
#
...
#   - Sign (PDF/JPEG metadata reading)
#   - Verify (evaluation + licensed modes)
...
#   --filter PATTERN        Run only tests matching pattern (e.g., Sign)
...
#   ./02_test-all-scenarios.sh --version 26.7.0 --filter Sign
...
validate_environment() {
    ...
    if [ -d "$SAMPLE_DOCS_DIR" ]; then
        ...
        print_warning "Files directory not found. Creating empty directory."
...
main() {
    ...
    echo ""
    echo "╔════════════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Annotation.Mcp — Integration Test Runner (local) ║"
    echo "╚════════════════════════════════════════════════════════════╝"
    echo ""
