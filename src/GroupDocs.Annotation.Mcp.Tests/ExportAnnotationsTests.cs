...
public class ExportAnnotationsTests : IClassFixture<McpServerFixture>
{
    private readonly McpServerFixture _fixture;
    private readonly ITestOutputHelper _output;

    public ExportAnnotationsTests(McpServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    [Fact]
    public async Task ExportAnnotations_BlankPdf_ReportsNoAnnotations()
    {
        ...
        var response = await _fixture.Client.CallToolAsync(
            catalog.ExportAnnotations.Name,
